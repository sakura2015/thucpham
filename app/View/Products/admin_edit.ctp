...
<div class="form-group">
  ...
  <div class="col-lg-10">
    <?php echo $this->Html->image($this->request->data['Product']['image']) ?>
    <?php echo $this->Form->input('image',array('values'=>$this->request->data['Product']['image'],'type' =>'file','class'=>'form-control', 'placeholder'=>'Nhập ảnh')); ?>
  </div>
</div>
<div class="form-group">
